...
// // import { Mail, Lock, Eye, EyeOff, CheckCircle, Sparkles, ShieldCheck, ArrowRight, AlertCircle, Loader2 } from "lucide-react";
...
// //         localStorage.setItem("adminRank", response.data.data.user.adminIndex);
...
// //       const response = await axios.post("http://localhost:5000/api/admin/verify-login-otp", {
// //         email: emailForOtp,
// //         otp,
// //       });
...
// //             <p>Access your hiring dashboard and manage your talent pipeline.</p>
// //           </div>
...
// //               <InputField
// //                 label="Work Email" icon={<Mail size={16} />} type="email" name="email"
// //                 placeholder="jane.smith@company.com" value={formData.email}
// //                 onChange={handleChange} error={errors.email}
// //               />

// //               {!showOtpBox && (
// //                 <InputField
// //                   label="Password" icon={<Lock size={16} />} name="password" placeholder="••••••••"
// //                   type={showPassword ? "text" : "password"} value={formData.password} onChange={handleChange} error={errors.password}
...
// //                   <InputField
// //                     label="6-Digit OTP" icon={<ShieldCheck size={16} />} name="otp"
// //                     placeholder="000000" value={otp}
// //                     onChange={(e) => setOtp(e.target.value)}
// //                     rightIcon={
// //                       <button type="button" onClick={handleVerifyOtp} className="v-btn confirm">
// //                         {verifyingOtp ? "..." : "Verify"}
// //                       </button>
// //                     }
// //                   />
...
// //                 </button>
// //               ) : (
// //                  <p className="back-link" onClick={() => setShowOtpBox(false)}>Back to Password</p>
// //               )}

// //               <p className="instruction-text">
// //                 <AlertCircle size={11} />
// //                 <span>For admin login, requires email verification.</span>
// //               </p>
// //             </form>
// //           </div>
// //         </div>
...
// //           border-radius: 28px;
// //           overflow: hidden;
// //           box-shadow: 0 20px 50px rgba(7, 25, 82, 0.05);
...
// //         .hero-content p { margin-top: 15px; color: rgba(255,255,255,0.7); font-size: 15px; max-width: 320px; }
...
// //         .submit-btn:hover { background: #0b57d0; box-shadow: 0 10px 20px rgba(11, 87, 208, 0.15); }
...
// //         .otp-section { background: #f0f7ff; padding: 12px; border-radius: 16px; border: 1px dashed #0B57D0; margin-bottom: 15px; }
// //         .v-btn { background: #10b981; color: white; border: none; padding: 6px 12px; border-radius: 8px; font-size: 10px; font-weight: 800; cursor: pointer; }
// //         .back-link { font-size: 12px; color: #0B57D0; font-weight: 700; text-align: center; cursor: pointer; margin-top: 10px; }
// //         .cp { cursor: pointer; color: #94a3b8; }

// //         @media(max-width:1024px) { 
// //           .main-content { height: auto; max-height: none; border-radius: 0; }
// //           .left-panel { display: none; } 
// //           .login-container { height: auto; overflow: auto; padding: 40px 0; }
// //         }
// //       `}</style>
// //     </div>
// //   );
...
// //       transition: '0.2s'
// //     }}>
// //       <span style={{ color: error ? "#ef4444" : "#94a3b8", marginRight: "10px" }}>{icon}</span>
// //       <input {...props} disabled={disabled} style={{ flex: 1, border: "none", outline: "none", fontSize: "14px", fontWeight: "600", color: "#071952", background: "transparent" }} />
...
//               {!showOtpBox && (
//                 <InputField
//   // Remove the 'label' prop since we custom-rendered it above
//   icon={<Lock size={16} />} 
//   name="password" 
//   placeholder="••••••••"
...
//       <style>{`
//         .login-container { display: flex; align-items: center; justify-content: center; height: 100vh; font-family: 'Inter', sans-serif; background: #f8fafc; }
...
//           .main-content { max-width: 400px; height: auto; padding: 20px; border-radius: 20px; }
//         }
//       `}</style>
//     </div>
//   );
...
const Login = () => {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      setVerifyingOtp(true);
      const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/admin/verify-login-otp`, {
        email: emailForOtp,
        otp,
      });
